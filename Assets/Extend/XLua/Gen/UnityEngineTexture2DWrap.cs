...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTexture2DWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Texture2D), L, translator, 0, 19, 2, 0);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.Texture2D), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Texture2D), L, __CreateInstance, 3, 2, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Texture2D));
			...
			Utils.EndClassRegister(typeof(UnityEngine.Texture2D), L, translator);
        }
