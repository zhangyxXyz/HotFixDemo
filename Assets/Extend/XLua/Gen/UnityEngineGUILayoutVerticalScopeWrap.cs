...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGUILayoutVerticalScopeWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.GUILayout.VerticalScope), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(UnityEngine.GUILayout.VerticalScope), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.GUILayout.VerticalScope), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.GUILayout.VerticalScope));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.GUILayout.VerticalScope), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) >= 1 && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 2) || translator.Assignable<UnityEngine.GUILayoutOption>(L, 2)))
				{
					...
					UnityEngine.GUILayout.VerticalScope __cl_gen_ret = new UnityEngine.GUILayout.VerticalScope(options);
				...
				if(LuaAPI.lua_gettop(L) >= 2 && translator.Assignable<UnityEngine.GUIStyle>(L, 2) && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 3) || translator.Assignable<UnityEngine.GUILayoutOption>(L, 3)))
				{
					...
					UnityEngine.GUILayout.VerticalScope __cl_gen_ret = new UnityEngine.GUILayout.VerticalScope(style, options);
					translator.Push(L, __cl_gen_ret);
				...
				if(LuaAPI.lua_gettop(L) >= 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && translator.Assignable<UnityEngine.GUIStyle>(L, 3) && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 4) || translator.Assignable<UnityEngine.GUILayoutOption>(L, 4)))
				{
					...
					UnityEngine.GUILayout.VerticalScope __cl_gen_ret = new UnityEngine.GUILayout.VerticalScope(text, style, options);
					translator.Push(L, __cl_gen_ret);
				...
				if(LuaAPI.lua_gettop(L) >= 3 && translator.Assignable<UnityEngine.Texture>(L, 2) && translator.Assignable<UnityEngine.GUIStyle>(L, 3) && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 4) || translator.Assignable<UnityEngine.GUILayoutOption>(L, 4)))
				{
					...
					UnityEngine.GUILayout.VerticalScope __cl_gen_ret = new UnityEngine.GUILayout.VerticalScope(image, style, options);
					translator.Push(L, __cl_gen_ret);
				...
				if(LuaAPI.lua_gettop(L) >= 3 && translator.Assignable<UnityEngine.GUIContent>(L, 2) && translator.Assignable<UnityEngine.GUIStyle>(L, 3) && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 4) || translator.Assignable<UnityEngine.GUILayoutOption>(L, 4)))
				{
					...
					UnityEngine.GUILayout.VerticalScope __cl_gen_ret = new UnityEngine.GUILayout.VerticalScope(content, style, options);
					translator.Push(L, __cl_gen_ret);
