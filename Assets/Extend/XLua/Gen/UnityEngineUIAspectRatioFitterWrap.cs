...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIAspectRatioFitterWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.UI.AspectRatioFitter), L, translator, 0, 2, 2, 2);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.UI.AspectRatioFitter), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.UI.AspectRatioFitter), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.UI.AspectRatioFitter));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.UI.AspectRatioFitter), L, translator);
        }
        ...
        static int _s_set_aspectMode(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UI.AspectRatioFitter __cl_gen_to_be_invoked = (UnityEngine.UI.AspectRatioFitter)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.AspectRatioFitter.AspectMode __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.aspectMode = __cl_gen_value;
