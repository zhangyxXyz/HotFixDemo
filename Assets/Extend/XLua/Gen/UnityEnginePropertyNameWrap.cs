...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePropertyNameWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.PropertyName), L, translator, 1, 3, 0, 0);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.PropertyName), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.PropertyName), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "IsNullOrEmpty", _m_IsNullOrEmpty_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.PropertyName));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.PropertyName), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					UnityEngine.PropertyName __cl_gen_ret = new UnityEngine.PropertyName(name);
				...
				{
					UnityEngine.PropertyName other;translator.Get(L, 2, out other);
					
					UnityEngine.PropertyName __cl_gen_ret = new UnityEngine.PropertyName(other);
					translator.Push(L, __cl_gen_ret);
        ...
        static int _m_IsNullOrEmpty_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    UnityEngine.PropertyName prop;translator.Get(L, 1, out prop);
                    
                        bool __cl_gen_ret = UnityEngine.PropertyName.IsNullOrEmpty( prop );
        ...
        static int _m_GetHashCode(RealStatePtr L)
        {
            ...
            UnityEngine.PropertyName __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
