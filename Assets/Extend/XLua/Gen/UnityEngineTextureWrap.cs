...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTextureWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Texture), L, translator, 0, 1, 8, 7);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.Texture), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Texture), L, __CreateInstance, 2, 2, 2);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "SetGlobalAnisotropicFilteringLimits", _m_SetGlobalAnisotropicFilteringLimits_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Texture));
			...
			Utils.EndClassRegister(typeof(UnityEngine.Texture), L, translator);
        }
