...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemTypeWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(System.Type), L, translator, 0, 37, 55, 0);
			...
			Utils.EndObjectRegister(typeof(System.Type), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(System.Type), L, __CreateInstance, 15, 1, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(System.Type));
			Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "DefaultBinder", _g_get_DefaultBinder);
            
			
			Utils.EndClassRegister(typeof(System.Type), L, translator);
        }
