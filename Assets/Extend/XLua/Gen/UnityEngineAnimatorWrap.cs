...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimatorWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Animator), L, translator, 0, 53, 43, 19);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.Animator), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Animator), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "StringToHash", _m_StringToHash_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Animator));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.Animator), L, translator);
        }
