...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMeshColliderWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.MeshCollider), L, translator, 0, 0, 4, 4);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.MeshCollider), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.MeshCollider), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.MeshCollider));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.MeshCollider), L, translator);
        }
