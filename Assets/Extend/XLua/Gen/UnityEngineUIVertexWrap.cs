...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIVertexWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.UIVertex), L, translator, 0, 0, 8, 8);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.UIVertex), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.UIVertex), L, __CreateInstance, 1, 1, 1);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.UIVertex));
			...
			Utils.EndClassRegister(typeof(UnityEngine.UIVertex), L, translator);
        }
        ...
        static int _g_get_position(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
        ...
        static int _g_get_uv0(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.uv0);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_uv1(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.uv1);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_uv2(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.uv2);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_uv3(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.uv3);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_tangent(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineVector4(L, __cl_gen_to_be_invoked.tangent);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_uv0(RealStatePtr L)
        {
            ...
            try {
				...
				__cl_gen_to_be_invoked.uv0 = __cl_gen_value;
        ...
        static int _s_set_uv1(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                UnityEngine.Vector2 __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.uv1 = __cl_gen_value;
        ...
        static int _s_set_uv2(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                UnityEngine.Vector2 __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.uv2 = __cl_gen_value;
        ...
        static int _s_set_uv3(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UIVertex __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                UnityEngine.Vector2 __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.uv3 = __cl_gen_value;
        ...
        static int _s_set_tangent(RealStatePtr L)
        {
            ...
            try {
				...
				__cl_gen_to_be_invoked.tangent = __cl_gen_value;
        ...
        static int _s_set_simpleVert(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			UnityEngine.UIVertex __cl_gen_value;translator.Get(L, 1, out __cl_gen_value);
				UnityEngine.UIVertex.simpleVert = __cl_gen_value;
