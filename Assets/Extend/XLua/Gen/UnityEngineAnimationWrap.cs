...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Animation), L, translator, 0, 15, 7, 6);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.Animation), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Animation), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Animation));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.Animation), L, translator);
        }
