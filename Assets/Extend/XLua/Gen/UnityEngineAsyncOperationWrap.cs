...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAsyncOperationWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.AsyncOperation), L, translator, 0, 0, 4, 2);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.AsyncOperation), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.AsyncOperation), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.AsyncOperation));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.AsyncOperation), L, translator);
        }
