...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUILayoutGroupWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.UI.LayoutGroup), L, translator, 0, 4, 9, 2);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.UI.LayoutGroup), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.UI.LayoutGroup), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.UI.LayoutGroup));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.UI.LayoutGroup), L, translator);
        }
        ...
        static int _s_set_childAlignment(RealStatePtr L)
        {
            ...
            try {
				...
				__cl_gen_to_be_invoked.childAlignment = __cl_gen_value;
