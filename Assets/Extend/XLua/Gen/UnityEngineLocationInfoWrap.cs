...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLocationInfoWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.LocationInfo), L, translator, 0, 0, 6, 0);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.LocationInfo), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.LocationInfo), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.LocationInfo));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.LocationInfo), L, translator);
        }
        ...
        static int _g_get_latitude(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.LocationInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
        ...
        static int _g_get_altitude(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.LocationInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.altitude);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_horizontalAccuracy(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.LocationInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.horizontalAccuracy);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_verticalAccuracy(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.LocationInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.verticalAccuracy);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
