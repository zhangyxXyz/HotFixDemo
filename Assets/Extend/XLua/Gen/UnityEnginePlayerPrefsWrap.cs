...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePlayerPrefsWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.PlayerPrefs), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(UnityEngine.PlayerPrefs), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.PlayerPrefs), L, __CreateInstance, 11, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.PlayerPrefs));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.PlayerPrefs), L, translator);
        }
