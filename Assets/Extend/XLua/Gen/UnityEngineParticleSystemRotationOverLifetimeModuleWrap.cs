...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemRotationOverLifetimeModuleWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(UnityEngine.ParticleSystem.RotationOverLifetimeModule), L, translator, 0, 0, 8, 8);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.ParticleSystem.RotationOverLifetimeModule), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.ParticleSystem.RotationOverLifetimeModule), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.ParticleSystem.RotationOverLifetimeModule));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.ParticleSystem.RotationOverLifetimeModule), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.ParticleSystem.RotationOverLifetimeModule));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.ParticleSystem.RotationOverLifetimeModule constructor!");
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.ParticleSystem.RotationOverLifetimeModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
