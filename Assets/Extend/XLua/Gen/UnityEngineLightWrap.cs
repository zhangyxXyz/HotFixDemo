...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLightWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Light), L, translator, 0, 5, 22, 20);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.Light), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Light), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "GetLights", _m_GetLights_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Light));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.Light), L, translator);
        }
        ...
        static int _g_get_colorTemperature(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.colorTemperature);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_shadowResolution(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.shadowResolution);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_shadowCustomResolution(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.shadowCustomResolution);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_isBaked(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.isBaked);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_colorTemperature(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.colorTemperature = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_shadowResolution(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                UnityEngine.Rendering.LightShadowResolution __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.shadowResolution = __cl_gen_value;
        ...
        static int _s_set_shadowCustomResolution(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Light __cl_gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.shadowCustomResolution = LuaAPI.xlua_tointeger(L, 2);
