...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGraphicsWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Graphics), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(UnityEngine.Graphics), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Graphics), L, __CreateInstance, 16, 3, 1);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Graphics));
			...
			Utils.EndClassRegister(typeof(UnityEngine.Graphics), L, translator);
        }
