...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemRotationBySpeedModuleWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(UnityEngine.ParticleSystem.RotationBySpeedModule), L, translator, 0, 0, 9, 9);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.ParticleSystem.RotationBySpeedModule), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.ParticleSystem.RotationBySpeedModule), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.ParticleSystem.RotationBySpeedModule));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.ParticleSystem.RotationBySpeedModule), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.ParticleSystem.RotationBySpeedModule));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.ParticleSystem.RotationBySpeedModule constructor!");
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.ParticleSystem.RotationBySpeedModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
        ...
        static int _g_get_range(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.ParticleSystem.RotationBySpeedModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.range);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
