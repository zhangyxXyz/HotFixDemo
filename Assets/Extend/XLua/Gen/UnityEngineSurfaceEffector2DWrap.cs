...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSurfaceEffector2DWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.SurfaceEffector2D), L, translator, 0, 0, 6, 6);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.SurfaceEffector2D), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.SurfaceEffector2D), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.SurfaceEffector2D));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.SurfaceEffector2D), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.SurfaceEffector2D __cl_gen_ret = new UnityEngine.SurfaceEffector2D();
        ...
        static int _g_get_speed(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_speedVariation(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.speedVariation);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_forceScale(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.forceScale);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_useContactForce(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.useContactForce);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_useFriction(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.useFriction);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_useBounce(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.useBounce);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_speedVariation(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.speedVariation = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_forceScale(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.forceScale = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_useContactForce(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.useContactForce = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_useFriction(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.useFriction = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_useBounce(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.SurfaceEffector2D __cl_gen_to_be_invoked = (UnityEngine.SurfaceEffector2D)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.useBounce = LuaAPI.lua_toboolean(L, 2);
