...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAINavMeshAgentWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.AI.NavMeshAgent), L, translator, 0, 13, 35, 22);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.AI.NavMeshAgent), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.AI.NavMeshAgent), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.AI.NavMeshAgent));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.AI.NavMeshAgent), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AI.NavMeshAgent __cl_gen_ret = new UnityEngine.AI.NavMeshAgent();
        ...
        static int _m_SetDestination(RealStatePtr L)
        {
            ...
            UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
        ...
        static int _m_SetPath(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    UnityEngine.AI.NavMeshPath path = (UnityEngine.AI.NavMeshPath)translator.GetObject(L, 2, typeof(UnityEngine.AI.NavMeshPath));
        ...
        static int _m_CalculatePath(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    UnityEngine.Vector3 targetPosition;translator.Get(L, 2, out targetPosition);
                    UnityEngine.AI.NavMeshPath path = (UnityEngine.AI.NavMeshPath)translator.GetObject(L, 3, typeof(UnityEngine.AI.NavMeshPath));
        ...
        static int _g_get_navMeshOwner(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.navMeshOwner);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_updateUpAxis(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.updateUpAxis);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_isStopped(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.isStopped = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_path(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.path = (UnityEngine.AI.NavMeshPath)translator.GetObject(L, 2, typeof(UnityEngine.AI.NavMeshPath));
        ...
        static int _s_set_updateUpAxis(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.updateUpAxis = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_obstacleAvoidanceType(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                UnityEngine.AI.ObstacleAvoidanceType __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
