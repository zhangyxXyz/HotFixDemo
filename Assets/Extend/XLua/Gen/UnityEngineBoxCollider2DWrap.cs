...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineBoxCollider2DWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.BoxCollider2D), L, translator, 0, 0, 3, 3);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.BoxCollider2D), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.BoxCollider2D), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.BoxCollider2D));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.BoxCollider2D), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.BoxCollider2D __cl_gen_ret = new UnityEngine.BoxCollider2D();
        ...
        static int _g_get_size(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.BoxCollider2D __cl_gen_to_be_invoked = (UnityEngine.BoxCollider2D)translator.FastGetCSObj(L, 1);
