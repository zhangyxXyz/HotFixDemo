...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.ParticleSystem), L, translator, 0, 16, 30, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetSafeCollisionEventSize", _m_GetSafeCollisionEventSize);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetCollisionEvents", _m_GetCollisionEvents);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetSafeTriggerParticlesSize", _m_GetSafeTriggerParticlesSize);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetTriggerParticles", _m_GetTriggerParticles);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetTriggerParticles", _m_SetTriggerParticles);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSafeCollisionEventSize(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.GetSafeCollisionEventSize(  );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSafeTriggerParticlesSize(RealStatePtr L)
        {
            ...
            try {
                
                {
                    UnityEngine.ParticleSystemTriggerEventType type;translator.Get(L, 2, out type);
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.GetSafeTriggerParticlesSize( type );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetTriggerParticles(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles = (System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>)translator.GetObject(L, 3, typeof(System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>));
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.GetTriggerParticles( type, particles );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
