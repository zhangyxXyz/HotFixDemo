...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Physics), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(UnityEngine.Physics), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Physics), L, __CreateInstance, 31, 8, 8);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Physics));
			...
			Utils.EndClassRegister(typeof(UnityEngine.Physics), L, translator);
        }
