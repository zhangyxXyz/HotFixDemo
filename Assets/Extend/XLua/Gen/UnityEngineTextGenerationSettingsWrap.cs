...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTextGenerationSettingsWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.TextGenerationSettings), L, translator, 0, 1, 18, 18);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.TextGenerationSettings), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.TextGenerationSettings), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.TextGenerationSettings));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.TextGenerationSettings), L, translator);
        }
        ...
        static int _m_Equals(RealStatePtr L)
        {
            ...
            UnityEngine.TextGenerationSettings __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
            
            
            try {
                
                {
                    UnityEngine.TextGenerationSettings other;translator.Get(L, 2, out other);
        ...
        static int _g_get_textAnchor(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextGenerationSettings __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineTextAnchor(L, __cl_gen_to_be_invoked.textAnchor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_updateBounds(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextGenerationSettings __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.updateBounds);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_generationExtents(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextGenerationSettings __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.generationExtents);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_generateOutOfBounds(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextGenerationSettings __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.generateOutOfBounds);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_textAnchor(RealStatePtr L)
        {
            ...
            try {
				...
				__cl_gen_to_be_invoked.textAnchor = __cl_gen_value;
        ...
        static int _s_set_updateBounds(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextGenerationSettings __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                __cl_gen_to_be_invoked.updateBounds = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_generationExtents(RealStatePtr L)
        {
            ...
            try {
				...
				__cl_gen_to_be_invoked.generationExtents = __cl_gen_value;
        ...
        static int _s_set_generateOutOfBounds(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextGenerationSettings __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                __cl_gen_to_be_invoked.generateOutOfBounds = LuaAPI.lua_toboolean(L, 2);
