...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemForceOverLifetimeModuleWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.ParticleSystem.ForceOverLifetimeModule), L, translator, 0, 0, 9, 9);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.ParticleSystem.ForceOverLifetimeModule), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.ParticleSystem.ForceOverLifetimeModule), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.ParticleSystem.ForceOverLifetimeModule));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.ParticleSystem.ForceOverLifetimeModule), L, translator);
        }
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.ParticleSystem.ForceOverLifetimeModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
        ...
        static int _g_get_randomized(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.ParticleSystem.ForceOverLifetimeModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.randomized);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_randomized(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.ParticleSystem.ForceOverLifetimeModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                __cl_gen_to_be_invoked.randomized = LuaAPI.lua_toboolean(L, 2);
