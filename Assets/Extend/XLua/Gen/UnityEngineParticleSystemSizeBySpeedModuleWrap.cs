...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemSizeBySpeedModuleWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.ParticleSystem.SizeBySpeedModule), L, translator, 0, 0, 11, 11);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.ParticleSystem.SizeBySpeedModule), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.ParticleSystem.SizeBySpeedModule), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.ParticleSystem.SizeBySpeedModule));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.ParticleSystem.SizeBySpeedModule), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.ParticleSystem.SizeBySpeedModule));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.ParticleSystem.SizeBySpeedModule constructor!");
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.ParticleSystem.SizeBySpeedModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
