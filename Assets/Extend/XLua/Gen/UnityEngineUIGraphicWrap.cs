...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIGraphicWrap
    {
        ...
        static int _m_CrossFadeColor(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 5&& translator.Assignable<UnityEngine.Color>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                ...
                if(__gen_param_count == 6&& translator.Assignable<UnityEngine.Color>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 6)) 
                {
                    UnityEngine.Color targetColor;translator.Get(L, 2, out targetColor);
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool ignoreTimeScale = LuaAPI.lua_toboolean(L, 4);
