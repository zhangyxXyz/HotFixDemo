...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIScrollRectWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.UI.ScrollRect), L, translator, 0, 14, 27, 20);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.UI.ScrollRect), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.UI.ScrollRect), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.UI.ScrollRect));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.UI.ScrollRect), L, translator);
        }
        ...
        static int _g_get_horizontalScrollbarVisibility(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.horizontalScrollbarVisibility);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_verticalScrollbarVisibility(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.verticalScrollbarVisibility);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
