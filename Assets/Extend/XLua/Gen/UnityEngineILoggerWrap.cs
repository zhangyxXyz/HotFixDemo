...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineILoggerWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(UnityEngine.ILogger), L, translator, 0, 6, 3, 3);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.ILogger), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.ILogger), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.ILogger));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.ILogger), L, translator);
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int __CreateInstance(RealStatePtr L)
        {
            return LuaAPI.luaL_error(L, "UnityEngine.ILogger does not have a constructor!");
        }
