...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIDropdownOptionDataWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.UI.Dropdown.OptionData), L, translator, 0, 0, 2, 2);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.UI.Dropdown.OptionData), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.UI.Dropdown.OptionData), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.UI.Dropdown.OptionData));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.UI.Dropdown.OptionData), L, translator);
        }
