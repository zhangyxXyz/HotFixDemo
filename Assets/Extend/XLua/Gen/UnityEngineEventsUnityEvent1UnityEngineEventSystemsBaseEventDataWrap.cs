...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventsUnityEvent_1_UnityEngineEventSystemsBaseEventData_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>), L, translator, 0, 3, 0, 0);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>), L, translator);
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int __CreateInstance(RealStatePtr L)
        {
            return LuaAPI.luaL_error(L, "UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData> does not have a constructor!");
        }
