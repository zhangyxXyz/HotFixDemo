...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTextMeshWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.TextMesh), L, translator, 0, 0, 12, 12);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.TextMesh), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.TextMesh), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.TextMesh));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.TextMesh), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.TextMesh __cl_gen_ret = new UnityEngine.TextMesh();
        ...
        static int _g_get_offsetZ(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextMesh __cl_gen_to_be_invoked = (UnityEngine.TextMesh)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.offsetZ);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_alignment(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextMesh __cl_gen_to_be_invoked = (UnityEngine.TextMesh)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineTextAlignment(L, __cl_gen_to_be_invoked.alignment);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_anchor(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextMesh __cl_gen_to_be_invoked = (UnityEngine.TextMesh)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineTextAnchor(L, __cl_gen_to_be_invoked.anchor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_characterSize(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextMesh __cl_gen_to_be_invoked = (UnityEngine.TextMesh)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.characterSize);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_offsetZ(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextMesh __cl_gen_to_be_invoked = (UnityEngine.TextMesh)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.offsetZ = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_characterSize(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TextMesh __cl_gen_to_be_invoked = (UnityEngine.TextMesh)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.characterSize = (float)LuaAPI.lua_tonumber(L, 2);
