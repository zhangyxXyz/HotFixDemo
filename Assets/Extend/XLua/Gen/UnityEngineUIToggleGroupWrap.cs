...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIToggleGroupWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.UI.ToggleGroup), L, translator, 0, 6, 1, 1);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.UI.ToggleGroup), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.UI.ToggleGroup), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.UI.ToggleGroup));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.UI.ToggleGroup), L, translator);
        }
