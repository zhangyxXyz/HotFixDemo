...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAINavMeshPathWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(UnityEngine.AI.NavMeshPath), L, translator, 0, 2, 2, 0);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.AI.NavMeshPath), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.AI.NavMeshPath), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.AI.NavMeshPath));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.AI.NavMeshPath), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AI.NavMeshPath __cl_gen_ret = new UnityEngine.AI.NavMeshPath();
        ...
        static int _m_GetCornersNonAlloc(RealStatePtr L)
        {
            ...
            UnityEngine.AI.NavMeshPath __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshPath)translator.FastGetCSObj(L, 1);
