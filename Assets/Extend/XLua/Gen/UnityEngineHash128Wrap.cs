...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineHash128Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(UnityEngine.Hash128), L, translator, 1, 3, 1, 0);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.Hash128), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Hash128), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "Parse", _m_Parse_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Hash128));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.Hash128), L, translator);
        }
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				if (translator.Assignable<UnityEngine.Hash128>(L, 1) && translator.Assignable<UnityEngine.Hash128>(L, 2))
				{
					UnityEngine.Hash128 leftside;translator.Get(L, 1, out leftside);
					UnityEngine.Hash128 rightside;translator.Get(L, 2, out rightside);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need UnityEngine.Hash128!");
        ...
        static int _m_ToString(RealStatePtr L)
        {
            ...
            UnityEngine.Hash128 __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
        ...
        static int _m_Parse_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    string hashString = LuaAPI.lua_tostring(L, 1);
                    
                        UnityEngine.Hash128 __cl_gen_ret = UnityEngine.Hash128.Parse( hashString );
                        translator.Push(L, __cl_gen_ret);
