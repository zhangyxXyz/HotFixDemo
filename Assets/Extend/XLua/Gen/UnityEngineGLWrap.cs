...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGLWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.GL), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(UnityEngine.GL), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.GL), L, __CreateInstance, 32, 4, 4);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.GL));
			...
			Utils.EndClassRegister(typeof(UnityEngine.GL), L, translator);
        }
