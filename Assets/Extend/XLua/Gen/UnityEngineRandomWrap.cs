...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRandomWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Random), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(UnityEngine.Random), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Random), L, __CreateInstance, 4, 7, 1);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Random));
			...
			Utils.EndClassRegister(typeof(UnityEngine.Random), L, translator);
        }
