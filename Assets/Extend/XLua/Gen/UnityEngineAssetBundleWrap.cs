...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAssetBundleWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.AssetBundle), L, translator, 0, 10, 2, 0);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.AssetBundle), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.AssetBundle), L, __CreateInstance, 5, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.AssetBundle));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.AssetBundle), L, translator);
        }
