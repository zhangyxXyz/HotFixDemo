...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationStateWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.AnimationState), L, translator, 0, 2, 12, 10);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.AnimationState), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.AnimationState), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.AnimationState));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.AnimationState), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AnimationState __cl_gen_ret = new UnityEngine.AnimationState();
        ...
        static int _m_AddMixingTransform(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.Transform>(L, 2)) 
                {
                    ...
                    __cl_gen_to_be_invoked.AddMixingTransform( mix );
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.Transform>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    __cl_gen_to_be_invoked.AddMixingTransform( mix, recursive );
        ...
        static int _g_get_normalizedSpeed(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AnimationState __cl_gen_to_be_invoked = (UnityEngine.AnimationState)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.normalizedSpeed);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_normalizedTime(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AnimationState __cl_gen_to_be_invoked = (UnityEngine.AnimationState)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.normalizedTime = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_normalizedSpeed(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AnimationState __cl_gen_to_be_invoked = (UnityEngine.AnimationState)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.normalizedSpeed = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_blendMode(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AnimationState __cl_gen_to_be_invoked = (UnityEngine.AnimationState)translator.FastGetCSObj(L, 1);
                UnityEngine.AnimationBlendMode __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
