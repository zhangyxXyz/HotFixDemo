...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMathfWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Mathf), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(UnityEngine.Mathf), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Mathf), L, __CreateInstance, 54, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Mathf));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.Mathf), L, translator);
        }
        ...
        static int _m_CorrelatedColorTemperatureToRGB_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    float kelvin = (float)LuaAPI.lua_tonumber(L, 1);
                    
                        UnityEngine.Color __cl_gen_ret = UnityEngine.Mathf.CorrelatedColorTemperatureToRGB( kelvin );
