...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTargetJoint2DWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.TargetJoint2D), L, translator, 0, 0, 6, 6);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.TargetJoint2D), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.TargetJoint2D), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.TargetJoint2D));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.TargetJoint2D), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.TargetJoint2D __cl_gen_ret = new UnityEngine.TargetJoint2D();
        ...
        static int _g_get_anchor(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TargetJoint2D __cl_gen_to_be_invoked = (UnityEngine.TargetJoint2D)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_autoConfigureTarget(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TargetJoint2D __cl_gen_to_be_invoked = (UnityEngine.TargetJoint2D)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.autoConfigureTarget);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_autoConfigureTarget(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.TargetJoint2D __cl_gen_to_be_invoked = (UnityEngine.TargetJoint2D)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.autoConfigureTarget = LuaAPI.lua_toboolean(L, 2);
