...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineQualitySettingsWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.QualitySettings), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(UnityEngine.QualitySettings), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.QualitySettings), L, __CreateInstance, 5, 27, 24);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.QualitySettings));
			...
			Utils.EndClassRegister(typeof(UnityEngine.QualitySettings), L, translator);
        }
        ...
        static int _g_get_blendWeights(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			    translator.Push(L, UnityEngine.QualitySettings.blendWeights);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
