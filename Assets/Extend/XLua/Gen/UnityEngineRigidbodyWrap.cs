    ...
    public class UnityEngineRigidbodyWrap
    {
        ...
        static int _g_get_solverIterations(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Rigidbody __cl_gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.solverIterations);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_solverVelocityIterations(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Rigidbody __cl_gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.solverVelocityIterations);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_solverIterations(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Rigidbody __cl_gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.solverIterations = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _s_set_solverVelocityIterations(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Rigidbody __cl_gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.solverVelocityIterations = LuaAPI.xlua_tointeger(L, 2);
