...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCharacterControllerWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.CharacterController), L, translator, 0, 2, 12, 9);
        ...
        static int _g_get_collisionFlags(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.CharacterController __cl_gen_to_be_invoked = (UnityEngine.CharacterController)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.collisionFlags);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_minMoveDistance(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.CharacterController __cl_gen_to_be_invoked = (UnityEngine.CharacterController)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.minMoveDistance);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_enableOverlapRecovery(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.CharacterController __cl_gen_to_be_invoked = (UnityEngine.CharacterController)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.enableOverlapRecovery);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_minMoveDistance(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.CharacterController __cl_gen_to_be_invoked = (UnityEngine.CharacterController)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.minMoveDistance = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_enableOverlapRecovery(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.CharacterController __cl_gen_to_be_invoked = (UnityEngine.CharacterController)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.enableOverlapRecovery = LuaAPI.lua_toboolean(L, 2);
